...
metric =[
    ...
    'train_fname': r'/home/haha/Documents/PythonPrograms/VoxNet_Test/voxnet-master/scripts/ring_datas/ringdata_1D.tar',
    ...
    'train_fname': r'/home/haha/Documents/PythonPrograms/VoxNet_Test/voxnet-master/scripts/ring_datas/ringdata_2D.tar',
...
def get_model():
    ...
    dims=metric[0]['dims'] # change the index when changing input dims
